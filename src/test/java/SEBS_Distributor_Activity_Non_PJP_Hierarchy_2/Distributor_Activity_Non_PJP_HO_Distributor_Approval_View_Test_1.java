...
public class Distributor_Activity_Non_PJP_HO_Distributor_Approval_View_Test_1 extends BaseClass_HO_Portal {
    ...
    public void DistM_DistributorApprov_View() throws Exception {
        ...
        ObjectRepo.startTestAndLog_1_SS("SEBSNonPJP_HO_initial_Approval_View_Test_01", "Select Master Menu", () -> {
            Liabrary.custom_click(AP.getMaster(), "Select Master Menu");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBSNonPJP_HO_initial_Approval_View_Test_02", "Select Distributor Master Sub Menu", () -> {
            Liabrary.custom_click(AP.getDistributor_Master(), "Select Distributor Master sub menu");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBSNonPJP_HO_initial_Approval_View_Test_03", "Select Distributor Approval Sub Menu", () -> {
            Liabrary.custom_click(AP.getDistributor_Approval(), "Select Distributor Approval sub menu");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBSNonPJP_HO_initial_Approval_View_Test_04", "Verify Header Text is 'Distributor Approval'", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("SEBSNonPJP_HO_initial_Approval_View_Test_05", "Select Distributor Approval Grid Page", () -> {
            Liabrary.custom_click(AP.getDistributor_Approval_Grid_Page(), "Select Distributor Approval Grid Page");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBSNonPJP_HO_initial_Approval_View_Test_06", "Click on View Button", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("SEBSNonPJP_HO_initial_Approval_View_Test_07", "Download Document 1", () -> {
            Liabrary.custom_click(AP.getDocument_1(), "Distributor Approval");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBSNonPJP_HO_initial_Approval_View_Test_08", "Download Document 2", () -> {
            Liabrary.custom_click(AP.getDocument_2(), "Distributor Approval");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBSNonPJP_HO_initial_Approval_View_Test_09", "Download Document 3", () -> {
            Liabrary.custom_click(AP.getDocument_3(), "Distributor Approval");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBSNonPJP_HO_initial_Approval_View_Test_10", "Click on Close Button", () -> {
...
//        Thread.sleep(1000);
    ...
    public void DistM_DistributorApprov_View_NS2() throws Exception {
        ...
        ObjectRepo.startTestAndLog_1_NS("Without Select Approval grid page");
