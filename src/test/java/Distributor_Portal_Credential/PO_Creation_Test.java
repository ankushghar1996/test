...
//        Thread.sleep(1000);
    ...
    @Test(priority=1)
    public void PO_Creation_NS1() throws Exception {

        PO_Creation DIST = PageFactory.initElements(driver, PO_Creation.class);
        
        ObjectRepo.startTestAndLog_1_NS("Without Select Pricing Type value");
...
//        Thread.sleep(1000);
    ...
    @Test(priority=2)
    public void PO_Creation_NS2() throws Exception {
