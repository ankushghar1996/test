...
public class Retailer_PJP_HO_OutletMaster_ApprovalPageCred_1st extends BaseClass_HO_Portal {
    ...
    @Test(priority=0)
    public void PJP_HO_OutletMaster_ApprovalPageCred_1st() throws Exception {
...
//        Thread.sleep(1000);
    ...
    @Test(priority=1)
    public void PJP_HO_OutletMaster_ApprovalPageCred_1st_NS1() throws Exception {
...
//        Thread.sleep(1000);
    ...
    @Test(priority=2)
    public void PJP_HO_OutletMaster_ApprovalPageCred_1st_NS2() throws Exception {
