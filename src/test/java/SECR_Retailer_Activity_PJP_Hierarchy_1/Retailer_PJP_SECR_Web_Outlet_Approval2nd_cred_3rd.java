...
public class Retailer_PJP_SECR_Web_Outlet_Approval2nd_cred_3rd extends BaseClass_SECR_WebPortal{
	...
	@Test(priority=0)
    public void PJP_SECR_Web_Outlet_Approval2nd_cred_3rd() throws Exception {
...
//        Thread.sleep(1000);
	...
	@Test(priority=1)
    public void PJP_SECR_Web_Outlet_Approval2nd_cred_3rd_NS1() throws Exception {
...
//        Thread.sleep(1000);
	...
	@Test(priority=2)
    public void PJP_SECR_Web_Outlet_Approval2nd_cred_3rd_NS2() throws Exception {
