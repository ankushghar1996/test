...
public class Retailer_PJP_HO_OutletMaster_ViewPageCred_1st extends BaseClass_HO_Portal {
    ...
    @Test(priority=0)
    public void PJP_HO_OutletMaster_ViewPageCred_1st() throws Exception {
    ...
    @Test(priority=1)
    public void PJP_HO_OutletMaster_ViewPageCred_1st_NS1() throws Exception {

        OutletMaster_ViewPage view = PageFactory.initElements(driver, OutletMaster_ViewPage.class);

        // Package name + login name + class name + test case nmbr
        ObjectRepo.startTestAndLog_1_NS("Without Click Outlet Name Grid Value");
