...
public class Retailer_PJP_Distributor_Outlet_Approval_1st_Test_2nd extends Base_Class_Distributor {
    ...
    public void Outlet_ApprovalTest() throws Exception {
        ...
        ObjectRepo.startTestAndLog_1_SS("SECR_DB_Outlet_Approval_TC_08", "Click on Yes button", () -> {
...
//        });
    ...
    @Test(priority=1)
    public void PJP_Distributor_Outlet_Approval_1st_Test_2nd_NS1() throws Exception {
...
//        });
    ...
    @Test(priority=2)
    public void PJP_Distributor_Outlet_Approval_1st_Test_2nd_NS2() throws Exception {
