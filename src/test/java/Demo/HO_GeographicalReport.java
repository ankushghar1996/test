...
public class HO_GeographicalReport extends BaseClass{
	...
	WebElement Header_Text = driver.findElement(By.xpath("//h4[@id='ParentMasterContentPlaceHolder1_headerpages']"));
	...
	ObjectRepo.startTestAndLog_1_SS("Test Case 4", "Verify that user should be click on Product Dropdown");	
	Liabrary.custom_click(GHR.getProduct_Dropdown(),"Product Dropdown");
	Thread.sleep(1000);
	
	
	ObjectRepo.startTestAndLog_1_SS("Test Case 5", "Verify that user should be Select Product Dropdown Value");	
	Liabrary.custom_click(GHR.getProduct_Dropdown_Value(),"Product Dropdown Value");
	Thread.sleep(1000);
	
	
	ObjectRepo.startTestAndLog_1_SS("Test Case 6", "Verify that user should be Select Sales Hierarchy Dropdown");
	Liabrary.custom_click(GHR.getSales_Hierarchy_Dropdown(),"Sales Hierarchy Dropdown");
	Thread.sleep(1000);
	
	
	ObjectRepo.startTestAndLog_1_SS("Test Case 7", "Verify that user should be Select Sales Hierarchy Dropdown Value");	
	Liabrary.custom_click(GHR.getSales_Hierarchy_Dropdown_Value(),"Select Sales Hierarchy Dropdown Value");
	Thread.sleep(1000);
	
	
	//Geography Hierarchy
	ObjectRepo.startTestAndLog_1_SS("Test Case 8", "Verify that user should be select Geography Hierarchy Dropdown ");	
	Liabrary.custom_click(GHR.getGeography_Hierarchy_Dropdown(),"select Geography Hierarchy Dropdown ");
	Thread.sleep(1000);
	

	ObjectRepo.startTestAndLog_1_SS("Test Case 9", "Verify that user should be select Geography Hierarchy Dropdown Value ");	
	Liabrary.custom_click(GHR.getGeography_Hierarchy_Dropdown_Value(),"select Geography Hierarchy Dropdown Value");
	Thread.sleep(1000);
	

	ObjectRepo.startTestAndLog_1_SS("Test Case 10", "Verify that user should be select For Year Dropdown");
	Liabrary.custom_click(GHR.getFor_Year_Dropdown(),"select For Year Dropdown ");
	Thread.sleep(1000);
	
	
	ObjectRepo.startTestAndLog_1_SS("Test Case 11", "Verify that user should be select For Year Dropdown Value");	
	Liabrary.custom_click(GHR.getFor_Year_Dropdown_Value(),"select For Year Dropdown Value");
	Thread.sleep(1000);
	
	
	ObjectRepo.startTestAndLog_1_SS("Test Case 12", "Verify that user should be select For Month Dropdown");
	Liabrary.custom_click(GHR.getFor_Month_Dropdown(),"For Month Dropdown");
	Thread.sleep(1000);
	
	
	ObjectRepo.startTestAndLog_1_SS("Test Case 13", "Verify that user should be select For Month Dropdown Value");
	Liabrary.custom_click(GHR.getFor_Month_Dropdown_Value(),"select For Month Dropdown Value");
	Thread.sleep(1000);
	
	
	ObjectRepo.startTestAndLog_1_SS("Test Case 14", "Verify that user should be select Report Level Dropdown");
	Liabrary.custom_click(GHR.getReport_Level_Dropdown(),"Report Level Dropdown");
	Thread.sleep(1000);
	
	
	ObjectRepo.startTestAndLog_1_SS("Test Case 15", "Verify that user should be select Report Level Dropdown Value");
	Liabrary.custom_click(GHR.getReport_Level_Dropdown_Value(),"Report Level Dropdown Value");
	Thread.sleep(1000);
	
	
	ObjectRepo.startTestAndLog_1_SS("Test Case 16", "Verify that user should be Click on View Button");
     Liabrary.custom_click(GHR.getView_Button(),"View Button");
     Thread.sleep(1000);

     
     ObjectRepo.startTestAndLog_1_SS("Test Case 17", "Verify that user should be Select Grid Data value");	
     Liabrary.custom_click(GHR.getGrid_Data_Value(),"Select Grid Data value");
     Thread.sleep(1000);
     
     
     ObjectRepo.startTestAndLog_1_SS("Test Case 18", "Verify that user should be Click on Download button");
   ...
   public void Negative_Scenario_2() throws Exception{
	   HomePage hp2 = PageFactory.initElements(driver,HomePage.class);
	    ...
	    ObjectRepo.startTestAndLog_1_SS("Test Case 1", "Verify that user should be Click On Reports menu");
	  	...
	  	ObjectRepo.startTestAndLog_1_SS("Test Case 3", "Verify that user should be Click On Sales_Hierarchy_Dropdown");	
	  	 Liabrary.custom_click(GHR2.getSales_Hierarchy_Dropdown(),"Click on Sales Hierarchy Dropdown");
	  	 Thread.sleep(1000);	
	  	 
	  	ObjectRepo.startTestAndLog_1_SS("Test Case 4", "Verify that user should be Click On Sales_Hierarchy_Dropdown_Value");
	  	 Liabrary.custom_click(GHR2.getSales_Hierarchy_Dropdown_Value(),"Click on Sales Hierarchy Dropdown Value");
	  	 Thread.sleep(1000);
	  	 
	  	 
	  	ObjectRepo.startTestAndLog_1_SS("Test Case 5", "Verify that user should be Click On View btn.");
