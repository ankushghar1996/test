...
public class OM_Outlet_Approval2nd_cred extends BaseClass_SECR_WebPortal{
    ...
    public void Outlet_Approval() throws Exception {
        ...
        ObjectRepo.startTestAndLog_1_SS("SECR_Web_OM_Outlet_Approval2nd_cred_TC06", "Verify that user should be click on Approve btn", () -> {
            Liabrary.custom_click(SECR.getApprove_btn(), "click Approve btn");
        });
        Thread.sleep(1000);
		
		
        ObjectRepo.startTestAndLog_1_SS("SECR_Web_OM_Outlet_Approval2nd_cred_TC07", "Verify that user should be click on Yes btn", () -> {
...
//        Thread.sleep(1000);
	...
	@Test(priority = 1)
    public void Outlet_Approval_NS_01() throws Exception {
...
//        Thread.sleep(1000);
	...
	@Test(priority = 2)
    public void Outlet_Approval_NS_02() throws Exception {
...
//        Thread.sleep(1000);
	...
	@Test(priority = 3)
    public void Outlet_Approval_NS_03() throws Exception {

		OM_Outlet_Approval2nd_main SECR = PageFactory.initElements(driver, OM_Outlet_Approval2nd_main.class);
	

		// Without click Approve btn
		ObjectRepo.startTestAndLog_1_NS("Without click Approve btn");
