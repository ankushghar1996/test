...
//			Thread.sleep(1000);
			...
			ObjectRepo.startTestAndLog_1_SS("SA_Applicator_Master_View_Page_TC03", "Click On Applicator Master", () -> {
			Liabrary.custom_click(AP.getApplicator_Master(), "Click On Applicator Master");});
			Thread.sleep(1000);
...
//			Thread.sleep(2000);
	    ...
	    ObjectRepo.startTestAndLog_1_SS("SA_Applicator_Master_View_Page_TC05", "Click on Applicator Grid Data Table", () -> {
		Liabrary.custom_click(APV.getApplicator_GridaDataTable(), "Click on Applicator Grid Data Table");});
		Thread.sleep(1000);
		
		ObjectRepo.startTestAndLog_1_SS("SA_Applicator_Master_View_Page_TC06", "Click on View Button", () -> {
		Liabrary.custom_click(APV.getView_Btn(), "Click on View Button");});
		Thread.sleep(1000);
