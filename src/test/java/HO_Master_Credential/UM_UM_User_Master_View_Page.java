...
public class UM_UM_User_Master_View_Page extends BaseClass{
	    ...
	    @Test(priority=1)
		public void UM_User_Master_View_NS1() throws Exception{
		HomePage hp = PageFactory.initElements(driver,HomePage.class);
		Common_Data CD = PageFactory.initElements(driver, Common_Data.class);	
		UM_User_Master	UM1 = PageFactory.initElements(driver,UM_User_Master.class); 
		UM_User_Master_View_Page UM2 = PageFactory.initElements(driver,UM_User_Master_View_Page.class); 
...
//			ObjectRepo.startTestAndLog_1_SS("SA_UM_User_Master_View_Page_TC10", "Click on View Button", () -> {		
//		driver.findElement(By.xpath("//*[@id='ParentMasterContentPlaceHolder1_BtnView']")).click();
//			});
//		Thread.sleep(1000);	
	    ...
	    @Test(priority=2)
		public void UM_User_Master_View_NS2() throws Exception{
		HomePage hp = PageFactory.initElements(driver,HomePage.class);
		Common_Data CD = PageFactory.initElements(driver, Common_Data.class);	
		UM_User_Master	UM1 = PageFactory.initElements(driver,UM_User_Master.class); 
		UM_User_Master_View_Page UM2 = PageFactory.initElements(driver,UM_User_Master_View_Page.class); 
		...
		ObjectRepo.startTestAndLog_1_NS("Without Selecting Grid data from list");
