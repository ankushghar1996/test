...
public class UM_UM_User_Master_Add_Page extends BaseClass{
    ...
    HomePage hp = PageFactory.initElements(driver,HomePage.class);
   	...
   	UM_User_Master_Add_Page UM3 = PageFactory.initElements(driver, UM_User_Master_Add_Page.class);	
		...
		Liabrary.custom_click(UM3.getUser_Type_Dropdown(), null);
		...
		Liabrary.custom_click(UM3.getUser_Type_Dropdown_Value(), null);
			});
		
		//Name
		ObjectRepo.startTestAndLog_1_SS("SA_UM_User_Master_Add_Page_TC_09", "Enter User Name", () -> {
		Liabrary.custom_Sendkeys(UM3.getName_Textbox(),"text", null);
		});
		Thread.sleep(1000);
		...
		Liabrary.custom_Sendkeys(UM3.getEmail_Textbox(),"hspl@gmail.com", null);
		});
		Thread.sleep(1000);	
