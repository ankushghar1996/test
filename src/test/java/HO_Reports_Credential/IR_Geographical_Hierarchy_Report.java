...
public class IR_Geographical_Hierarchy_Report extends BaseClass {
    ...
    public void Inventory_FlashBy_Product_Report_NS01() throws Exception {
        ...
        ObjectRepo.startTestAndLog_1_NS("Without click on Geographical Hierarchy Report Menu");
...
//        Thread.sleep(1000);
    ...
    public void Inventory_FlashBy_Product_Report_NS02() throws Exception {
        ...
        ObjectRepo.startTestAndLog_1_NS("Without click on Inventory Report SubMenu");
