...
public class Retailer_Non_PJP_Distributor_Outlet_Approval_1st_Test_2nd extends Base_Class_Distributor {
    ...
    public void Outlet_ApprovalTest() throws Exception {
     ...
     // Package name + login name + class name + test case nmbr
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_DB_Outlet_Approval_TC_08", "Click on Yes button", () -> {
...
//        });
    ...
    public void Outlet_ApprovalTest_NS1() throws Exception {
     ...
     // Package name + login name + class name + test case nmbr
        ...
        ObjectRepo.startTestAndLog_1_NS("Without Click Approval Button");
...
//        });
    ...
    public void Outlet_ApprovalTest_NS2() throws Exception {
     ...
     // Package name + login name + class name + test case nmbr
        ...
        ObjectRepo.startTestAndLog_1_NS("Without Click Without grid table");
