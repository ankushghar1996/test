...
public class Retailer_Non_PJP_HO_OutletMaster_ApprovalPageCred_1st extends BaseClass_HO_Portal {
    ...
    public void OM_View() throws Exception {
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_HO_OutletMaster_ApprovalPageCred_TC06", "Click Approval Button", () -> {
            Liabrary.custom_click(Appr.getApproval_btn(), "Click Approval Button");
        });
        Thread.sleep(1000);

  
        ObjectRepo.startTestAndLog_1_SS("FSG_HO_OutletMaster_ApprovalPageCred_TC08", "Click ProceedForApproval Button", () -> {
            Liabrary.custom_click(Appr.getProceedForApproval_btn(), "Click ProceedForApproval Button");
        });
        Thread.sleep(1000);
        

        ObjectRepo.startTestAndLog_1_SS("FSG_HO_OutletMaster_ApprovalPageCred_TC09", "Click Yes Button", () -> {
