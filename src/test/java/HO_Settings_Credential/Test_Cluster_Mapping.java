...
public class Test_Cluster_Mapping extends BaseClass {
    ...
    public void Cluster_Mapping() throws Exception {
        ...
        ObjectRepo.startTestAndLog_1_SS("SA_Test_Cluster_Mapping_TC_12", "Select Area Name from dropdown.", () -> {
            ...
            driver.findElement(By.xpath("(//*[@id='ctl00_ParentMasterContentPlaceHolder1_ddlAreaName_DropDown']//ul//li)[1]")).click();
        });
        Thread.sleep(1000);

        
        ObjectRepo.startTestAndLog_1_SS("SA_Test_Cluster_Mapping_TC_13", "Select Parent Area from dropdown.", () -> {
            WebElement element3 = driver.findElement(By.xpath("//span[@id='ctl00_ParentMasterContentPlaceHolder1_ddlParentArea_Arrow']"));
            ...
            driver.findElement(By.xpath("(//*[@id='ctl00_ParentMasterContentPlaceHolder1_ddlParentArea_DropDown']//ul//li)[1]")).click();
        });
        Thread.sleep(1000);
    ...
    @Test(priority=1)
    public void Cluster_Mapping_NS1() throws Exception {
    	
        HomePage hp = PageFactory.initElements(driver, HomePage.class);
        //ABC
        Cluster_Mapping CM = PageFactory.initElements(driver, Cluster_Mapping.class);
        ObjectRepo.startTestAndLog_1_NS("Without Select Cluster Mapping Page");
...
//        Thread.sleep(1000);
    ...
    @Test(priority=2)
    public void Cluster_Mapping_NS2() throws Exception {
    	
        HomePage hp = PageFactory.initElements(driver, HomePage.class);
        //ABC
        Cluster_Mapping CM = PageFactory.initElements(driver, Cluster_Mapping.class);
        
        ObjectRepo.startTestAndLog_1_NS("Without Select Cluster Mapping Dropdown");
