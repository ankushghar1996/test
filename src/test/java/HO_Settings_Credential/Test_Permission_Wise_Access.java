...
public class Test_Permission_Wise_Access extends BaseClass {
    ...
    @Test(priority=1)
    public void Permission_Wise_Access_NS1() throws Exception {
    	
        HomePage hp = PageFactory.initElements(driver, HomePage.class);
        Permission_Wise_Access PWA = PageFactory.initElements(driver, Permission_Wise_Access.class);
        
        ObjectRepo.startTestAndLog_1_NS("Without Select Permission Wise Access Page");
...
//        Thread.sleep(1000);
    ...
    @Test(priority=2)
    public void Permission_Wise_Access_NS02() throws Exception {
    	
        HomePage hp = PageFactory.initElements(driver, HomePage.class);
        Permission_Wise_Access PWA = PageFactory.initElements(driver, Permission_Wise_Access.class);

        ObjectRepo.startTestAndLog_1_NS("Without Select User Dropdown");
