...
public class Test_Role_Wise_Access extends BaseClass {
    ...
    @Test(priority=1)
    public void Role_Wise_Access_NS1() throws Exception {
        HomePage hp = PageFactory.initElements(driver, HomePage.class);
        Role_Wise_Access RWA = PageFactory.initElements(driver, Role_Wise_Access.class);
        
        ObjectRepo.startTestAndLog_1_NS("Without Select Role Wise Access Page");
...
//        Thread.sleep(1000);
    ...
    @Test(priority=2)
    public void Role_Wise_Access_NS2() throws Exception {
        HomePage hp = PageFactory.initElements(driver, HomePage.class);
        Role_Wise_Access RWA = PageFactory.initElements(driver, Role_Wise_Access.class);
        
        ObjectRepo.startTestAndLog_1_NS("Without Select Type Dropdown");
