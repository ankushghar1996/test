...
public class Retailer_Non_PJP_HO_OutletMaster_Reject_PageCred_1st_ extends BaseClass_HO_Portal {
...
//        Thread.sleep(1000);
    ...
    @Test(priority=1)
    public void OM_Reject_NS1() throws Exception {
...
//        Thread.sleep(1000);
    ...
    @Test(priority=2)
    public void OM_Reject_NS2() throws Exception {
 
        OutletMaster_ApprovalPage Appr = PageFactory.initElements(driver, OutletMaster_ApprovalPage.class);
        
        ObjectRepo.startTestAndLog_1_NS("Without Click Reject Button");
