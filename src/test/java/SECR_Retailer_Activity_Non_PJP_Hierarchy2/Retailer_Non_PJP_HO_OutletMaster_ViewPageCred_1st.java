...
public class Retailer_Non_PJP_HO_OutletMaster_ViewPageCred_1st extends BaseClass_HO_Portal {
    ...
    public void OM_View() throws Exception {
        ...
        ObjectRepo.startTestAndLog_1_SS("SECR_HO_Activity_Non_PJP_OutletMaster_ViewPageCred_TC01", "Click Master Menu", () -> {
            Liabrary.custom_click(view.getMaster_Menu(), null);
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SECR_HO_Activity_Non_PJP_OutletMaster_ViewPageCred_TC02", "Click Outlet Master Menu", () -> {
            Liabrary.custom_click(view.getOutlet_Master_Menu(), null);
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SECR_HO_Activity_Non_PJP_OutletMaster_ViewPageCred_TC03", "Click Outlet Approval Submenu", () -> {
            Liabrary.custom_click(view.getOutlet_Approval_SubMenu(), null);
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SECR_HO_Activity_Non_PJP_OutletMaster_ViewPageCred_TC04", "Verify Approval Heading Text", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("SECR_HO_Activity_Non_PJP_OutletMaster_ViewPageCred_TC05", "Click Outlet Name Grid Value", () -> {
            Liabrary.custom_click(view.getOutlet_Name_Common_Value(), null);
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SECR_HO_Activity_Non_PJP_OutletMaster_ViewPageCred_TC06", "Click View Button", () -> {
            Liabrary.custom_click(view.getView_btn(), null);
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SECR_HO_Activity_Non_PJP_OutletMaster_ViewPageCred_TC07", "Verify Outlet Details Header", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("SECR_HO_Activity_Non_PJP_OutletMaster_ViewPageCred_TC08", "Click Close Button", () -> {
    ...
    @Test(priority=1)
    public void Non_PJP_HO_OutletMaster_ViewPage_NS1() throws Exception {

        OutletMaster_ViewPage view = PageFactory.initElements(driver, OutletMaster_ViewPage.class);

        // Package name + login name + class name + test case nmbr
        
        ObjectRepo.startTestAndLog_1_NS("Without Click on Outlet Approval Submenu");
...
//        Thread.sleep(1000);
    ...
    @Test(priority=1)
    public void Non_PJP_HO_OutletMaster_ViewPage_NS2() throws Exception {
