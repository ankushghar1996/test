...
public class Distributor_Activity_PJP_HO_Distributor_Approval_Page_Test_1st extends BaseClass_HO_Portal{
	...
	public void DistM_DistributorApprov() throws Exception {
		...
		ObjectRepo.startTestAndLog_1_SS("SEBS_PJP_HO_initial_Approval_Test_01", "Verify that user should be click on HO_Portal Master menu.", () -> {
		Liabrary.custom_click(APP.getMaster(), "select Master Menu");
		});
		Thread.sleep(1000);
		
	
		ObjectRepo.startTestAndLog_1_SS("SEBS_PJP_HO_initial_Approval_Test_02", "Verify that user should click on HO_Portal Distributor Master menu.", () -> {
		    Liabrary.custom_click(APP.getDistributor_Master(), "select Distributor Master sub menu");
		});
		Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_PJP_HO_initial_Approval_Test_03", "Verify that user should click on HO_Portal Distributor Approval menu.", () -> {
		    Liabrary.custom_click(APP.getDistributor_Approval(), "select Distributor Approval sub menu");
		});
		Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_PJP_HO_initial_Approval_Test_04", "Verify that user should see Distributor Approval header text.", () -> {
		...
		ObjectRepo.startTestAndLog_1_SS("SEBS_PJP_HO_initial_Approval_Test_05", "Verify that user should select Distributor Approval grid row.", () -> {
		    Liabrary.custom_click(APP.getDistributor_Approval_Grid_Page(), "Select Distributor Approval Grid Page");
		});
		Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_PJP_HO_initial_Approval_Test_06", "Verify that user should click on Distributor Approval button.", () -> {
		    Liabrary.custom_click(APP.getApproval_btn(), "click on Distributor Approval button");
		});
		Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_PJP_HO_initial_Approval_Test_07", "Verify that user should click on ProceedFor Approval button.", () -> {
		    Liabrary.custom_click(APP.getProceedForApproval_btn(), "click on ProceedFor Approval button");
		});
		Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_PJP_HO_initial_Approval_Test_08", "Verify that user should click on Yes button.", () -> {
