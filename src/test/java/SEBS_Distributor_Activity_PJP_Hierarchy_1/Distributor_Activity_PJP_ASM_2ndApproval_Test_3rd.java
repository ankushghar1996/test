...
public class Distributor_Activity_PJP_ASM_2ndApproval_Test_3rd extends BaseClass_ASM {
	...
	ObjectRepo.startTestAndLog_1_SS("SEBSPJP_ASM_2nd_Approval_Test_01", "Verify that user should be click on ASM_Portal Master menu.", () -> {
	Liabrary.custom_click(ASM.getMaster(), "Click on Master");
	});
	Thread.sleep(1000);
	
	ObjectRepo.startTestAndLog_1_SS("SEBSPJP_ASM_2nd_Approval_Test_02", "Verify that user should click on ASM_Portal Distributor Master menu.", () -> {
	    Liabrary.custom_click(ASM.getDistributor_Master(), "Click on Distributor Master");
	});
	Thread.sleep(1000);
	

	ObjectRepo.startTestAndLog_1_SS("SEBSPJP_ASM_2nd_Approval_Test_03", "Verify that user should click on ASM_Portal Distributor 2nd Approval menu.", () -> {
	    Liabrary.custom_click(ASM.getDistributor_Approval_2nd(), "Click Distributor Approval 2nd");
	});
	Thread.sleep(1000);
	

	ObjectRepo.startTestAndLog_1_SS("SEBSPJP_ASM_2nd_Approval_Test_04", "Verify that user should select Distributor Approval grid row.", () -> {
	    Liabrary.custom_click(ASM.getGrid_Data(), "Select Grid Data From Grid Table");
	});
	Thread.sleep(1000);
	

	ObjectRepo.startTestAndLog_1_SS("SEBSPJP_ASM_2nd_Approval_Test_05", "Verify that user should click on Approval button.", () -> {
	    Liabrary.custom_click(ASM.getApproval_Page_Button(), "Click on Approval Button");
	});
	Thread.sleep(1000);
	

	ObjectRepo.startTestAndLog_1_SS("SEBSPJP_ASM_2nd_Approval_Test_06", "Scroll to Documents section on Approval page.", () -> {
	...
	ObjectRepo.startTestAndLog_1_SS("SEBSPJP_ASM_2nd_Approval_Test_07", "Verify that user should click on Approve button.", () -> {
	    Liabrary.custom_click(ASM.getApprove_Button(), "Click on Approve Button");
	});
	Thread.sleep(1000);
	

	ObjectRepo.startTestAndLog_1_SS("SEBSPJP_ASM_2nd_Approval_Test_08", "Verify that user should click on Yes button.", () -> {
...
//	     Liabrary.custom_click(ASM.getNo_Button(), "Click on No Button");
	...
	ObjectRepo.startTestAndLog_1_NS("Without Click Distributor Approval 2nd ");
