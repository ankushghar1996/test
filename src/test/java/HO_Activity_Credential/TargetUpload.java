...
public class TargetUpload extends BaseClass {
	...
	public void Target_Upload_NS01() throws Exception {
		...
		ObjectRepo.startTestAndLog_1_NS("Without Select Target upload Page");
...
//		Thread.sleep(1000);
	...
	@Test(priority=2)
	public void Target_Upload_NS02() throws Exception {

		HomePage hp = PageFactory.initElements(driver, HomePage.class);
		ActivityMaster_TargetUpload TU = PageFactory.initElements(driver, ActivityMaster_TargetUpload.class);
		Common_Data CD = PageFactory.initElements(driver, Common_Data.class);
		
		ObjectRepo.startTestAndLog_1_NS("Without Select User Type 1 Dropdown");
