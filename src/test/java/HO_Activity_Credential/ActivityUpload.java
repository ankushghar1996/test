...
public class ActivityUpload extends BaseClass{
	...
	//	ObjectRepo.test.log(Status.INFO, "Test Case 3 : Verify that user should be select Activity Upload Page.");
	...
	//	ObjectRepo.test.log(Status.INFO, "Test Case 4 : Verify that user should be Target Upload Header Text.");
   	...
   	//	ObjectRepo.test.log(Status.INFO, "Test Case 5 : Verify that user should be select User Type1 dropdown.");
		Liabrary.custom_click(AU.getUserType1_Dropdown(), "select User Type1 dropdown");
		Thread.sleep(1000);
