...
public class Activity_PJP_New_Retailer_Cred {
     ...
     public void setupSuite() {
	    ...
	    public void testOtpFlowAndRetailerInfo() throws Exception {
	        String mobileNumber = "8585906072";
	    ...
	    private void NewRetailerInfo() throws InterruptedException {
	        ...
	        driver.findElement(By.xpath("//input[@placeholder='Enter Retailer Firm Name/Outlet Name']")).sendKeys("santosh thakur hardware");
	        });
	        Thread.sleep(1000);
	    ...
	    private static String getOtpFromDb(String mobileNumber) {
	        ...
	        try {
	            ...
	            String query = "select * from RegistrationPendingMaster where MobileNo='8585906072'";
