...
public class Activity_Non_PJP_New_Retailer_Cred {
     ...
     public void setupSuite() {
	    ...
	    public void testOtpFlowAndRetailerInfo() throws Exception {
	        ...
	        String mobileNumber = "7777888823";
	    ...
	    private void NewRetailerInfo() throws InterruptedException {
	        ...
	        ObjectRepo.startTestAndLog_1_SS("SECR_Activity_Non_PJP_New_Retailer_Cred_TC_11", "Verify that user should be click on Distributor dropdown.", () -> {
		        ...
		        driver.findElement(By.xpath("//input[@placeholder='Enter Retailer Firm Name/Outlet Name']")).sendKeys("kanchan shastri Paints");
		        });
		        Thread.sleep(1000);
	...
	// You can add more fields here as needed
	    ...
	    private static String getOtpFromDb(String mobileNumber) {
	        ...
	        try {
	            ...
	            String query = "select * from RegistrationPendingMaster where MobileNo='7777888823'";
