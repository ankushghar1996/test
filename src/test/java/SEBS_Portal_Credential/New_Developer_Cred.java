...
//		
	...
	public void SECR_ViewProfile_NS01() throws Exception { 
		...
		//Without click Developer add Menu
  		ObjectRepo.startTestAndLog_1_NS("Without click Developer add Menu");
...
//		Thread.sleep(1000);
	...
	public void SECR_ViewProfile_NS02() throws Exception { 
		...
		// Without Click Developer Creation SubMenu
  		ObjectRepo.startTestAndLog_1_NS("Without Click Developer Creation SubMenu");
...
//		Thread.sleep(1000);
	...
	public void SECR_ViewProfile_NS_04() throws Exception { 
		...
		// Click on Cancel btn
  		ObjectRepo.startTestAndLog_1_NS("Click on Cancel btn");
	   ...
	   ObjectRepo.startTestAndLog_1_SS("SEBS_New_Developer_Cred_TC_19", "Enter PIN Code", () ->{	
		...
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Developer_TC_26", "Click on Cancel button ", () ->{
		Liabrary.custom_click(view.getCANCEL_Button(), "Click on Cancel button"); });
		Thread.sleep(3000);
