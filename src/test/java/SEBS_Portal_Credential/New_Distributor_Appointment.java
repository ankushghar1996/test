...
public class New_Distributor_Appointment {
	    ...
	    public void testOtpFlowAndRetailerInfo() throws Exception {
	        ...
	        String mobileNumber = "9082956067";
	    ...
	    private void AddDistributorInfo() throws InterruptedException {
	        ...
	        driver.findElement(By.xpath("//input[@placeholder='Enter Distributor Firm Name']")).sendKeys("komal trhakur enterprises");});
	        Thread.sleep(1000);
	   ...
	   //     Thread.sleep(1000);
	    ...
	    private static String getOtpFromDb(String mobileNumber) {
	        ...
	        try {
	            ...
	            String query = "select * from RegistrationPendingMaster where MobileNo='9082956067'";
