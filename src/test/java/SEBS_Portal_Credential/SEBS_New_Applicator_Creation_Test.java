...
public class SEBS_New_Applicator_Creation_Test extends BaseClass_SEBS_Portal {
	...
	public void Applicator_creation () throws Exception {
		...
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC04", "Click On Distributor Dropdown", () -> {
		    Liabrary.custom_click(SEBS.getSelect_Distributor_Dropdown(), "Click On Distributor Dropdown"); });
		    Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC05", "Click On Distributor Dropdown Value", () -> {
		    Liabrary.custom_click(SEBS.getSelect_Distributor_Dropdown_Value(), "Click On Distributor Dropdown Value");});
		    Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC06", "Click on Sales_Engineer_Dropdown", () -> {
		    Liabrary.custom_click(SEBS.getSales_Engineer_Dropdown(), "Click on Sales_Engineer_Dropdown");});
		    Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC07", "Click on Sales_Engineer_Dropdown Value", () -> {
		    Liabrary.custom_click(SEBS.getSales_Engineer_Dropdown_Value(), "Click on Sales_Engineer_Dropdown Value");});
		    Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC08", "Click on Route Button", () -> {
		    Liabrary.custom_click(SEBS.getRoute(), "Click on Route Button");});
		    Thread.sleep(1000);
	

		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC09", "Click on Route Button Value", () -> {
		    Liabrary.custom_click(SEBS.getRoute_Value(), "Click on Route Button Value");});
		    Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC10", "Enter Applicator Name", () -> {
		    driver.findElement(By.xpath("//div[@class='col-12 mb-3']//input[@formcontrolname='ApplicatorName']")).sendKeys("HSPL ");});
		    Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC11", "Scroll to Applicator Type", () -> {
		...
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC12", "Click on Applicator Type", () -> {
		    Liabrary.custom_click(SEBS.getApplicator_Type(), "Click on Applicator Type"); });
		    Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC13", "Click on Applicator Type Value", () -> {
		    Liabrary.custom_click(SEBS.getApplicator_Type_Value(), "Click on Applicator Type Value"); });
		    Thread.sleep(1000);
		

		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC14", "Enter Contact Number", () -> {
		    driver.findElement(By.xpath("//input[@placeholder='Enter Contact Number']")).sendKeys("123456789");});
		    Thread.sleep(1000);
	

		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC15", "Scroll to Email Address", () -> {
		...
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC16", "Enter Email", () -> {
		    driver.findElement(By.xpath("//input[@placeholder='Enter Email Address']")).sendKeys("HSPL@Test.com");
		});
		Thread.sleep(1000);
		
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC17", "Enter Address Line 1", () -> {
		    driver.findElement(By.xpath("//input[@placeholder='Enter Address Line 1']")).sendKeys("Navle Bridge");
		});
		Thread.sleep(1000);
		
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC18", "Enter Address Line 2", () -> {
		    driver.findElement(By.xpath("//input[@placeholder='Enter Address Line 2']")).sendKeys("Narhe");
		});
		Thread.sleep(1000);
		
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC19", "Click on State Dropdown", () -> {
		    Liabrary.custom_click(SEBS.getState_Dropdown(), "Click on State Drpopdown");
		});
		Thread.sleep(1000);
		
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC20", "Click on State Dropdown Value", () -> {
		    Liabrary.custom_click(SEBS.getState_Dropdown_Value(), "Click on State Drpopdown Value");
		});
		Thread.sleep(1000);
		
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC21", "Click on City Dropdown", () -> {
		    Liabrary.custom_click(SEBS.getCity_Dropdown(), "Click on City Dropdown");
		});
		Thread.sleep(1000);
		
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC22", "Click on City Dropdown Value", () -> {
		    Liabrary.custom_click(SEBS.getCity_Dropdown_Value(), "Click on City Dropdown Value");
		});
		Thread.sleep(1000);
		
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC23", "Enter Pin Code", () -> {
		...
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC24", "Enter Aadhar Number", () -> {
		    driver.findElement(By.xpath("//input[@placeholder='Enter Aadhar Number']")).sendKeys("123456789");
		   
		});
		Thread.sleep(1000);

		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC25", "Enter PAN Number", () -> {
		    driver.findElement(By.xpath("//input[@placeholder='Enter PAN Number']")).sendKeys("AZVPK2525M");
		    
		});
		Thread.sleep(1000);
		
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC26", "Scroll to Camera Icon", () -> {
		...
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC27", "Enter GST Number", () -> {
		...
		Thread.sleep(1000);
		  ...
		  //Camera Click
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC28", "Select camera  and capture 1", () -> {
	       ...
	       ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC29", "Select camera  and capture 2", () -> {
	       ...
	       ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC29", "Select camera  and capture 3", () -> {
	       ...
	       Thread.sleep(1000);
	       ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC29", "Click on save button", () -> {
