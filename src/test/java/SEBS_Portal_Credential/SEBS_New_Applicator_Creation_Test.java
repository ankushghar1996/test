...
public class SEBS_New_Applicator_Creation_Test extends BaseClass_SEBS_Portal {
	...
	public void Applicator_creation () throws Exception {
		    ...
		    driver.findElement(By.xpath("//input[@placeholder='Enter Mobile Number']")).sendKeys("9658741305");
		    });
		    Thread.sleep(1000);
		...
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Applicator_Creat TC12", "Enter Applicator Name", () -> {
		    driver.findElement(By.xpath("//div[@class='col-12 mb-3']//input[@formcontrolname='ApplicatorName']")).sendKeys("kanchan jadhav");});
		    Thread.sleep(1000);
