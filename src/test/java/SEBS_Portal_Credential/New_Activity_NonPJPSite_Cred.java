...
public class New_Activity_NonPJPSite_Cred extends BaseClass_SEBS_Portal {
    ...
    public void SEBS_New_Activity_PJP_Cred() throws Exception {
        ...
        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC01", "Click on Activity Button", () -> {
            Liabrary.custom_click(view.getActivity_Button(), "Click on Activity Button");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC02", "Click on Non-PJP Button", () -> {
		...
		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC04", "Click on CONTINUE Button", () -> {
		driver.findElement(By.xpath("//button[normalize-space()='CONTINUE']")).click();});
		Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC05", "Click on Add1 Button", () -> {
            Liabrary.custom_click(view.getAdd1_Button(), "Click on Add1 Button");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC06", "Click on Distributor Mapped", () -> {
            Liabrary.custom_click(view.getDistributor_Mapped(), "Click on Distributor Mapped");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC07", "Select Distributor Mapped", () -> {
            Liabrary.custom_click(view.getSelect_Distributor_Mapped(), "Select Distributor Mapped");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC08", "Click Sales Engineer Dropdown", () -> {
            Liabrary.custom_click(view.getSelect_sales_Engineer_dropdown(), "Click Sales Engineer Dropdown");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC09", "Select Sales Engineer", () -> {
            Liabrary.custom_click(view.getSelect_sales_Engineer(), "Select Sales Engineer");
        });
        Thread.sleep(1000);

        
        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC10", "Click Location Dropdown", () -> {
            Liabrary.custom_click(view.getSelect_Location_dropdown(), "Click Location Dropdown");
        });
        Thread.sleep(1000);
        

        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC11", "Select Location", () -> {
            Liabrary.custom_click(view.getSelect_Location(), "Select Location");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC12", "Click Developer Dropdown", () -> {
            Liabrary.custom_click(view.getSelect_developer_Name_dropdown(), "Click Developer Dropdown");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC13", "Select Developer Name", () -> {
            Liabrary.custom_click(view.getSelect_developer_Name(), "Select Developer Name");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC14", "Scroll to Site Name", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_16", "Click on Chcekbox_flexCheckDefault", () ->{
            ...
            ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_17", "Enter Project Funnel (lakhs) of Site", () ->{
            driver.findElement(By.xpath("//input[@placeholder='Enter Project Funnel (lakhs) of Site']")).sendKeys("40");});
            Thread.sleep(1000);
            
            
            ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_18", "Enter Sales Funnel (lakhs) of Site", () ->{
            driver.findElement(By.xpath("(//input[@placeholder='Enter Sales Funnel (lakhs) of Site'])[1]")).sendKeys("521");});
            Thread.sleep(1000);
            
            
            ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_19", "Enter Fosroc Expected sales in 2025", () ->{
            ...
            ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_20", "Enter YTD Sales (lakhs)", () ->{
            driver.findElement(By.xpath("//input[@placeholder='Enter YTD Sales (lakhs)']")).sendKeys("3214");});
            Thread.sleep(1000);
            
    		
            ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_21", "Click on Dropdown Menu Button", () ->{
            Liabrary.custom_click(view.getDropdownMenuButton(), "Click on Dropdown Menu Button");});
            Thread.sleep(1000);
            
    		
    		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_22", "Click on Checkbox", () ->{
            ...
            ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_23", "Enter Contractor Name", () ->{
    		driver.findElement(By.xpath("//input[@placeholder='Enter Contractor Name']")).sendKeys("sahil");});
            Thread.sleep(1000);
            
            
            ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_24", "Click on Chcekbox_flexCheckDefault", () ->{
            driver.findElement(By.xpath("//input[@placeholder='Enter Contractor Email ID.']")).sendKeys("sahil123@gmail.com");});
            Thread.sleep(1000);
            
    		
    		ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_25", "Enter Contractor Contact Number", () ->{
    		driver.findElement(By.xpath("//input[@placeholder='Enter Contractor Contact Number.']")).sendKeys("9654120165");});
    		  Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_26", "Click on camera button", ()-> {  
	        ...
	        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_27", "Select camera  and capture", ()-> {  
	        ...
	        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_28", "Select camera  and capture", ()-> { 
	...
	ObjectRepo.startTestAndLog_1_SS("SEBS_New_Activity_NonPJP_TC_29", "Click on Save_Button", () ->{
