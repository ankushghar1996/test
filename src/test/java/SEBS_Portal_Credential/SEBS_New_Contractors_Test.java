...
//        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("//input[@placeholder='Enter Mobile Number']")).sendKeys("9547821428");
        });
        Thread.sleep(1000);
        ...
        ObjectRepo.startTestAndLog_1_SS("SEBS_New_Contractors_Test_TC12", "Enter Contractor Name", () -> {
            driver.findElement(By.xpath("//input[@placeholder='Enter Contractor Name']")).sendKeys("nilesh sharma");
...
//        Thread.sleep(1000);
    ...
    @Test(priority = 2)
    public void New_Contractors_NS_02() throws Exception {
        SEBS_New_Contractors SEBS = PageFactory.initElements(driver, SEBS_New_Contractors.class);

        
      //Without Click on Add Button
    ...
    @Test(priority = 3)
    public void New_Contractors_NS_03() throws Exception {
	
    SEBS_New_Contractors SEBS = PageFactory.initElements(driver, SEBS_New_Contractors.class);

  //Without Enter Mandatory Field
		ObjectRepo.startTestAndLog_1_NS("Without Enter Mandatory Field");
