...
public class Market_Non_PJP_New_Retailer_Creation {
    ...
    public void testOtpFlowAndRetailerInfo() throws Exception {
        String mobileNumber = "8585906055";
    ...
    private void enterRetailerInfo() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@placeholder='Enter Retailer Firm Name/Outlet Name']")).sendKeys("tanmay thakur Paints and Hardware");
        });
        Thread.sleep(1000);
...
//        Thread.sleep(1000);
 ...
 private static String getOtpFromDb(String mobileNumber) {
        ...
        try {
            ...
            String query = "select * from RegistrationPendingMaster where MobileNo='8585906055'";
