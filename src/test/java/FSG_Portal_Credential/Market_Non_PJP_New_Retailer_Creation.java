...
public class Market_Non_PJP_New_Retailer_Creation {
    ...
    public void testOtpFlowAndRetailerInfo() throws Exception {
        String mobileNumber = "8585906057";
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_02", "Verify that user should be send FSG Password.", () -> {
        driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys("Fosroc@1");
        });
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_03", "Verify that user should be click on Login Button.", () -> {
        driver.findElement(By.xpath("//button[@class='btn btn-primary w-100']")).click();
        });
        Thread.sleep(1000);

        // Navigate
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_04", "Verify that user should be click on  Market Tab.", () -> {
            driver.findElement(By.xpath("//div[@routerlink='/market']")).click();
            });
            Thread.sleep(1000);
            
            
            ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_05", "Verify that user should be click on Non PJP Retailers  Menu.", () -> {
            driver.findElement(By.xpath("//div[@class='col-6 fw-bold opacity-75 text-center market-tabs']")).click();
            });
            Thread.sleep(1000);

            
            // Retailer Add
            ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_06", "Verify that user should be click on Add button.", () -> {
            driver.findElement(By.xpath("//img[@src='../../../../../assets/icons/common-icons/retailer-add.svg']")).click();
            });
            Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_07", "Verify that user should be send Mobile Number.", () -> {
        driver.findElement(By.xpath("//input[@placeholder='Enter Mobile Number']")).sendKeys(mobileNumber);
        });
        Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_08", "Verify that user should be click on Send OTP Button.", () -> {
        ...
        if (otp != null) {
            ...
            ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_09", "Verify that user should be send OTP.", () -> {
    ...
    private void enterRetailerInfo() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@placeholder='Enter Retailer Firm Name/Outlet Name']")).sendKeys("pintu bhai thakur Paints and Hardware");
        });
        Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_12", "Verify that user should be click on Retailer Category dropdown.", () -> {
        driver.findElement(By.xpath("//div[@class='ng-input']/input[@type='text']")).click();
        });
        Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_13", "Verify that user should be select Retailer in Retailer Category dropdown.", () -> {
        driver.findElement(By.xpath("//span[normalize-space()='Paint']")).click();
        });
        Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_14", "Verify that user should be click on Route dropdown.", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_16", "Verify that user should be Enter Contact Person Name.", () -> {
        driver.findElement(By.xpath("//input[@placeholder='Enter Contact Person Name']")).sendKeys("vinay the don");
        });
        Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_17", "Verify that user should be Enter Email Address.", () -> {
        driver.findElement(By.xpath("//input[@placeholder='Enter Email Address']")).sendKeys("vinat123@gmail.com");
        });
        Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_18", "Verify that user should be Enter Address Line 1.", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_21", "Verify that user should be Enter Pin Code.", () -> {
        driver.findElement(By.xpath("//input[@placeholder='Enter Pin Code']")).sendKeys("441601");
        });
        Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_22", "Verify that user should be Enter PAN Number.", () -> {
        driver.findElement(By.xpath("//input[@placeholder='Enter PAN Number']")).sendKeys("DARDH4445K");
        });
        Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_23", "Verify that user should be Enter GST Number.", () -> {
        driver.findElement(By.xpath("//input[@placeholder='Enter GST Number']")).sendKeys("29AAACC1206D2ZB");
        });
        Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_24", "Verify that user should be Enter Total Business In CC.", () -> {
        driver.findElement(By.xpath("//input[@placeholder='Enter Total Business In CC']")).sendKeys("123456");
        });
        Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_25", "Verify that user should be click on Retailer class dropdown.", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_Market_Non_PJP_New_Retailer_Creation_TC_26", "Verify that user should be select Retailer class in Retailer class dropdown.", () -> {
...
//        Thread.sleep(1000);
 ...
 private static String getOtpFromDb(String mobileNumber) {
        ...
        try {
            ...
            String query = "select * from RegistrationPendingMaster where MobileNo='8585906057'";
