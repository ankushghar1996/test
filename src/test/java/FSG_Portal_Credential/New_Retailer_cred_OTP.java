...
public class New_Retailer_cred_OTP {
    ...
    public void testOtpFlowAndRetailerInfo() throws Exception {
        String mobileNumber = "9145851206";
    ...
    private void enterRetailerInfo() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@placeholder='Enter Retailer Firm Name/Outlet Name']")).sendKeys("rahul kulkarni Paints and Hardware");
        });
        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("//input[@placeholder='Enter Contact Person Name']")).sendKeys("Chotu sharma");
        });
        Thread.sleep(1000);
        
        
        ObjectRepo.startTestAndLog_1_SS("FSG_New_Retailer_cred_OTP_TC_17", "Verify that user should be Enter Email Address.", () -> {
        driver.findElement(By.xpath("//input[@placeholder='Enter Email Address']")).sendKeys("Chotu123@gmail.com");
        });
        Thread.sleep(1000);
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_New_Retailer_cred_OTP_TC_30", "Verify that user should be click on SAVE button.", () -> {
...
//        
    ...
    private static String getOtpFromDb(String mobileNumber) {
        ...
        try {
            ...
            String query = "select * from RegistrationPendingMaster where MobileNo='9145851206'";
