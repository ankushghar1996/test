...
public class Market_PJP_New_Retailer_Creation {
    ...
    public void testOtpFlowAndRetailerInfo() throws Exception {
        String mobileNumber = "9145854252";
    ...
    private void enterRetailerInfo() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@placeholder='Enter Retailer Firm Name/Outlet Name']")).sendKeys("Roshan kumbhare Paints and Hardware");
        });
        Thread.sleep(1000);
...
//        Thread.sleep(1000);
    ...
    private static String getOtpFromDb(String mobileNumber) {
        ...
        try {
            ...
            String query = "select * from RegistrationPendingMaster where MobileNo=9145854252";
