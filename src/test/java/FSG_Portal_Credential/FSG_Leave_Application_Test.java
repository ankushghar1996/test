...
public class FSG_Leave_Application_Test extends BaseClass_FSG_Portal {
	...
	driver.findElement(By.xpath("(//input[@type='date'])[1]")).sendKeys("26-07-2025");});
	Thread.sleep(1000);
	
	ObjectRepo.startTestAndLog_1_SS("FSG_Leave_Application_Test_05", "Verify that user can enter To Date", () -> {
	driver.findElement(By.xpath("(//input[@type='date'])[2]")).sendKeys("26-07-2025"); });
	Thread.sleep(1000);
...
//    Thread.sleep(1000);
	...
	public void FSG_leave_NS1 () throws Exception {		
		FSG_Leave_Application_Main FSG = PageFactory.initElements(driver , FSG_Leave_Application_Main.class);
		
		ObjectRepo.startTestAndLog_1_NS("without Click on Leave Type Value Button");
		...
		ObjectRepo.startTestAndLog_1_SS("FSG_Leave_Application_Test_04", "Verify that user can enter From Date", () -> {
		driver.findElement(By.xpath("(//input[@type='date'])[1]")).sendKeys("29-06-2025");});
		Thread.sleep(1000);
		
		ObjectRepo.startTestAndLog_1_SS("FSG_Leave_Application_Test_05", "Verify that user can enter To Date", () -> {
		driver.findElement(By.xpath("(//input[@type='date'])[2]")).sendKeys("29-06-2025"); });
		Thread.sleep(1000);
...
//	    Thread.sleep(1000);
	...
	public void FSG_leave_NS2() throws Exception {
		
		FSG_Leave_Application_Main FSG = PageFactory.initElements(driver , FSG_Leave_Application_Main.class);
		
		ObjectRepo.startTestAndLog_1_NS("without Click on Apply Button");
