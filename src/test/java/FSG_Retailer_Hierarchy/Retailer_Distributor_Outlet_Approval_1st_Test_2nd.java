...
public class Retailer_Distributor_Outlet_Approval_1st_Test_2nd extends Base_Class_Distributor {
    ...
    public void Outlet_Test() throws Exception {
     ...
     // Package name + login name + class name + test case nmbr
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_Outlet_Approval_TC_01", "Click on Master menu", () -> {
            Liabrary.custom_click(DIST.getMaster(), "Click on Master");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("FSG_Outlet_Approval_TC_02", "Click on Outlet Master", () -> {
            Liabrary.custom_click(DIST.getOutlet_Master(), "Click on Outlet Master");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("FSG_Outlet_Approval_TC_03", "Click on Outlet Approval 1st", () -> {
            Liabrary.custom_click(DIST.getOutlet_Approval_1st(), "Click Outlet Approval 1st");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("FSG_Outlet_Approval_TC_04", "Select Grid Data From Grid Table", () -> {
            Liabrary.custom_click(DIST.getGrid_Data(), "Select Grid Data From Grid Table");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("FSG_Outlet_Approval_TC_05", "Click on Approval button", () -> {
            Liabrary.custom_click(DIST.getApproval_Page_Button(), "Click on Approval Button");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("FSG_Outlet_Approval_TC_06", "Scroll to Documents section", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_Outlet_Approval_TC_07", "Click on Approve button", () -> {
            Liabrary.custom_click(DIST.getApprove_Button(), "Click on Approve Button");
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("FSG_Outlet_Approval_TC_08", "Click on Yes button", () -> {
