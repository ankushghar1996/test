...
public class Retailer_Distributor_Outlet_Approval_1st_View_Test_2nd extends Base_Class_Distributor {
    ...
    public void Outlet_View() throws Exception {
     ...
     // Package name + login name + class name + test case nmbr
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_Outlet_Approval_1st_View_Test_2nd_TC_02", "Click on Outlet Master", () -> {
            Liabrary.custom_click(DIST.getOutlet_Master(), "Click on Outlet Master");
        });

        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_Outlet_Approval_1st_View_Test_2nd_TC_03", "Click on Outlet Approval 1st", () -> {
            Liabrary.custom_click(DIST.getOutlet_Approval_1st(), "Click Outlet Approval 1st");
        });

        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_Outlet_Approval_1st_View_Test_2nd_TC_04", "Select Grid Data From Grid Table", () -> {
            Liabrary.custom_click(DIST.getGrid_Data(), "Select Grid Data From Grid Table");
        });

        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_Outlet_Approval_1st_View_Test_2nd_TC_05", "Click on View Button", () -> {
            Liabrary.custom_click(DIST.getView_Button(), "Click on View Button");
        });

        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_Outlet_Approval_1st_View_Test_2nd_TC_06", "Scroll to the Documents section", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_Outlet_Approval_1st_View_Test_2nd_TC_07", "Click on Close Button", () -> {
    ...
    public void Outlet_View_NS1() throws Exception {
     ...
     // Package name + login name + class name + test case nmbr
        ObjectRepo.startTestAndLog_1_NS("Without Select grid data");
