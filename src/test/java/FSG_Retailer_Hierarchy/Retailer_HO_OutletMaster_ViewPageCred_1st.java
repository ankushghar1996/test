...
public class Retailer_HO_OutletMaster_ViewPageCred_1st extends BaseClass_HO_Portal {
    ...
    public void OM_View() throws Exception {
     ...
     // Package name + login name + class name + test case nmbr
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_OutletMaster_ViewPageCred_1st_TC_01", "Click Master Menu", () -> {
            Liabrary.custom_click(view.getMaster_Menu(), null);
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_OutletMaster_ViewPageCred_1st_TC_02", "Click Outlet Master Menu", () -> {
            Liabrary.custom_click(view.getOutlet_Master_Menu(), null);
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_OutletMaster_ViewPageCred_1st_TC_03", "Click Outlet Approval Submenu", () -> {
            Liabrary.custom_click(view.getOutlet_Approval_SubMenu(), null);
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_OutletMaster_ViewPageCred_1st_TC_04", "Verify Approval Heading Text", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_OutletMaster_ViewPageCred_1st_TC_05", "Click Outlet Name Grid Value", () -> {
            Liabrary.custom_click(view.getOutlet_Name_Common_Value(), null);
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_OutletMaster_ViewPageCred_1st_TC_06", "Click View Button", () -> {
            Liabrary.custom_click(view.getView_btn(), null);
        });
        Thread.sleep(1000);

        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_OutletMaster_ViewPageCred_1st_TC_07", "Verify Outlet Details Header", () -> {
        ...
        ObjectRepo.startTestAndLog_1_SS("FSG_Retailer_OutletMaster_ViewPageCred_1st_TC_08", "Click Close Button", () -> {
...
//        Thread.sleep(1000);
    ...
    public void OM_View_NS2() throws Exception {
     ...
     // Package name + login name + class name + test case nmbr
        ...
        ObjectRepo.startTestAndLog_1_NS("Without Click Outlet Name Common Value");
