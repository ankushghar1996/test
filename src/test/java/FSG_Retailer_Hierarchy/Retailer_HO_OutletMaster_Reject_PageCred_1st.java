...
public class Retailer_HO_OutletMaster_Reject_PageCred_1st extends BaseClass_HO_Portal {
...
//        Thread.sleep(1000);
    ...
    @Test(priority=1)
    public void OM_Reject_NS01() throws Exception {
...
//        Thread.sleep(1000);
    ...
    @Test(priority=2)
    public void OM_Reject_NS02() throws Exception {
