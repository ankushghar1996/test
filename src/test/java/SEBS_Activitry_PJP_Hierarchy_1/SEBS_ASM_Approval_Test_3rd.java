...
public class SEBS_ASM_Approval_Test_3rd extends BaseClass_ASM {
	...
	ObjectRepo.startTestAndLog_1_SS("ASM_ASM_Approval_Test_TC_01", "Verify that user should be click on ASM_Portal Master menu.", () -> {
