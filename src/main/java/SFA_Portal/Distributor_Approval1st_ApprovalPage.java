...
public class Distributor_Approval1st_ApprovalPage {
	...
	@FindBy(how = How.XPATH, using = "(//table[@id='ctl00_ParentMasterContentPlaceHolder1_radGridSFAApprovalList_ctl00']//tr)[2]")
