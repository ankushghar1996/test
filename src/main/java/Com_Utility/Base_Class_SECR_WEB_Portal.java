package Com_Utility;
	...
	public class Base_Class_SECR_WEB_Portal {
...
import SCER_Web_Portal.SECR_Login_main;
import io.github.bonigarcia.wdm.WebDriverManager;
	...
	public class Base_Class_SECR_WEB_Portal {
		...
		public void openbrowser() throws Exception {
		   // System.setProperty("webdriver.chrome.driver", "C:\\COde\\test\\FOSROC_Automation\\chromedriver-win64\\chromedriver.exe");
		    ...
		    SECR_Login_main login = PageFactory.initElements(driver, SECR_Login_main.class);
 
			
			Liabrary.custom_Sendkeys(login.getUserName(), excel.getStringdata2("Sheet1", 9, 0), "UserName Field");

			Liabrary.custom_Sendkeys(login.getPassword(), excel.getStringdata2("Sheet1", 9, 1), "Passwod Field");
