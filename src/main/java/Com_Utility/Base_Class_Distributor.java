...
public class Base_Class_Distributor {
    ...
    public void launchBrowserAndLogin() throws Exception {
        ...
        Liabrary.custom_Sendkeys(login.getUserName(), excel.getStringdata2("Sheet1", 8, 0), "Username Field");
        Thread.sleep(1000);
        
        Liabrary.custom_Sendkeys(login.getPassword(),excel.getStringdata2("Sheet1", 8, 1), "Password Field");
        Thread.sleep(1000);
