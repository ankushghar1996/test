...
public class SECR_MTD_Working_Main {
	...
	@FindBy(how=How.XPATH,using="//div[@class='col-12 mt-1']//span[text()='Rahul']")
    private WebElement MTD_Retailer;
	...
	public WebElement getMTD_Retailer() {
		return MTD_Retailer;
	}
